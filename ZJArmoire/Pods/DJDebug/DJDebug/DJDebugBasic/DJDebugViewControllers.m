...
#import "DJDebugViewControllers.h"
#import "DJDebug.h"
#import <objc/runtime.h>

@interface DJDebugViewControllers ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation DJDebugViewControllers
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if ([obj respondsToSelector:@selector(DJDebugViewController)]) {
        viewController = [obj DJDebugViewController];
    }
        ...
        if (classNames) {
            ...
            for (unsigned int i = 0; i < classNamesCount; i++) {
                ...
                if ([classNameString hasPrefix:@"FLEX"] ||
                    ...
                    [classNameString hasPrefix:@"DJDebug"]) {
                    continue ;
                }
                Class class = NSClassFromString(classNameString);
                if ([class isSubclassOfClass:[UIViewController class]]) {
                    if ([class instancesRespondToSelector:@selector(DJDebugViewController)]) {
