 ...
 * Implementations of `NSCoding`, `NSCopying`, `-hash` and `-isEqual:`.
 ...
 See `DJDebugModel` protocol for custom methods.
 
 
 Sample Code:
 
 ********************** json convertor *********************
 @interface DJDebugAuthor : NSObject
 @property (nonatomic, strong) NSString *name;
 @property (nonatomic, assign) NSDate *birthday;
 @end
 @implementation DJDebugAuthor
 @end
 
 @interface DJDebugBook : NSObject
 @property (nonatomic, copy) NSString *name;
 @property (nonatomic, assign) NSUInteger pages;
 @property (nonatomic, strong) DJDebugAuthor *author;
 @end
 @implementation DJDebugBook
 @end
 
 int main() {
 // create model from json
 DJDebugBook *book = [DJDebugBook DJDebug_modelWithJSON:@"{\"name\": \"Harry Potter\", \"pages\": 256, \"author\": {\"name\": \"J.K.Rowling\", \"birthday\": \"1965-07-31\" }}"];
 
 // convert model to json
 NSString *json = [book DJDebug_modelToJSONString];
 // {"author":{"name":"J.K.Rowling","birthday":"1965-07-31T00:00:00+0000"},"name":"Harry Potter","pages":256}
 }
 
 ********************** Coding/Copying/hash/equal *********************
 @interface DJDebugShadow :NSObject <NSCoding, NSCopying>
 @property (nonatomic, copy) NSString *name;
 @property (nonatomic, assign) CGSize size;
 @end
 
 @implementation DJDebugShadow
 - (void)encodeWithCoder:(NSCoder *)aCoder { [self DJDebug_modelEncodeWithCoder:aCoder]; }
 - (id)initWithCoder:(NSCoder *)aDecoder { self = [super init]; return [self DJDebug_modelInitWithCoder:aDecoder]; }
 - (id)copyWithZone:(NSZone *)zone { return [self DJDebug_modelCopy]; }
 - (NSUInteger)hash { return [self DJDebug_modelHash]; }
 - (BOOL)isEqual:(id)object { return [self DJDebug_modelIsEqual:object]; }
 @end
 
 */
@interface NSObject (DJDebugModel)
 ...
 */
+ (nullable instancetype)DJDebug_modelWithJSON:(id)json;
...
/**
 ...
 `NSString` -> NSDate, parsed with format "DJDebugDJDebug-MM-dd'T'HH:mm:ssZ", "DJDebugDJDebug-MM-dd HH:mm:ss" or "DJDebugDJDebug-MM-dd".
 `NSString` -> NSURL.
 `NSValue` -> struct or union, such as CGRect, CGSize, ...
 `NSString` -> SEL, Class.
 */
+ (nullable instancetype)DJDebug_modelWithDictionary:(NSDictionary *)dictionary;
 ...
 */
- (nullable id)DJDebug_modelToJSONObject;
 ...
 */
- (nullable NSData *)DJDebug_modelToJSONData;
...
/**
 ...
 inner object to json string.
 */
- (nullable NSString *)DJDebug_modelToJSONString;
 ...
 */
@interface NSArray (DJDebugModel)
 ...
 */
+ (nullable NSArray *)DJDebug_modelArrayWithClass:(Class)cls json:(id)json;
 ...
 */
@interface NSDictionary (DJDebugModel)
 ...
 */
+ (nullable NSDictionary *)DJDebug_modelDictionaryWithClass:(Class)cls json:(id)json;
@end
...
/**
 ...
 There's no need to add '<DJDebugModel>' to your class header.
 */
@protocol DJDebugModel <NSObject>
@optional
...
/**
 ...
 Example:
 @class DJDebugShadow, DJDebugBorder, DJDebugAttachment;
 
 @interface DJDebugAttributes
 @property NSString *name;
 ...
 @implementation DJDebugAttributes
 + (NSDictionary *)modelContainerPropertyGenericClass {
 return @{@"shadows" : [DJDebugShadow class],
 @"borders" : DJDebugBorder.class,
 @"attachments" : @"DJDebugAttachment" };
 }
 @end
...
/**
 ...
 Example:
 @class DJDebugCircle, DJDebugRectangle, DJDebugLine;
 
 @implementation DJDebugShape
 
 + (Class)modelCustomClassForDictionary:(NSDictionary*)dictionary {
 if (dictionary[@"radius"] != nil) {
 return [DJDebugCircle class];
 } else if (dictionary[@"width"] != nil) {
 return [DJDebugRectangle class];
 } else if (dictionary[@"y2"] != nil) {
 return [DJDebugLine class];
 } else {
 return [self class];
 }
 }
